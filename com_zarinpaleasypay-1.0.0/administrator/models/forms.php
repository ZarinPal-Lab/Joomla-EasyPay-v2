 ...
 * @since  1.6
 */
class ZarinpaleasypayModelForms extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__zarinpaleasypay_forms` AS a');
	...
	public function getItems()
	{
		...
		foreach ($items as $oneItem) {
					$oneItem->currency = JText::_('COM_ZARINPALEASYPAY_FORMS_CURRENCY_OPTION_' . strtoupper($oneItem->currency));
		}
		return $items;
	}
}
