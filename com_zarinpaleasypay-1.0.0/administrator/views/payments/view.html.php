 ...
 * @since  1.6
 */
class ZarinpaleasypayViewPayments extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ZarinpaleasypayHelpersZarinpaleasypay::addSubmenu('faktors', 'faktors');
		ZarinpaleasypayHelpersZarinpaleasypay::addSubmenu('payments', 'payments', true);
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ZARINPALEASYPAY_TITLE_PAYMENTS'), 'payments.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_zarinpaleasypay&view=payments');

		$this->extra_sidebar = '';
		//Filter for the field status
		$select_label = JText::sprintf('COM_ZARINPALEASYPAY_FILTER_SELECT_LABEL', JText::_('COM_ZARINPALEASYPAY_LBL_STATUS'));
		$options = array();
		$options[0] = new stdClass();
		$options[0]->value = "pending";
		$options[0]->text = JText::_('COM_ZARINPALEASYPAY_LBL_PENDING');
		$options[1] = new stdClass();
		$options[1]->value = "failed";
		$options[1]->text = JText::_('COM_ZARINPALEASYPAY_LBL_FAILED');
		$options[2] = new stdClass();
		$options[2]->value = "completed";
		$options[2]->text = JText::_('COM_ZARINPALEASYPAY_LBL_COMPLETED');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`faktor_id`' => JText::_('COM_ZARINPALEASYPAY_PAYMENTS_FAKTOR_ID'),
			'a.`status`' => JText::_('COM_ZARINPALEASYPAY_PAYMENTS_STATUS'),
			'a.`status_id`' => JText::_('COM_ZARINPALEASYPAY_PAYMENTS_STATUS_ID'),
			'a.`ref_id`' => JText::_('COM_ZARINPALEASYPAY_PAYMENTS_REF_ID'),
		);
	}
}
