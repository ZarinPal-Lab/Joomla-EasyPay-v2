 ...
 * @since  1.6
 */
class ZarinpaleasypayViewForm extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ZARINPALEASYPAY_TITLE_FORM'), 'form.png');
		...
		*/
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_zarinpaleasypay.form', $this->item->id);
		}
		*/
